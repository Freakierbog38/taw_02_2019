...
$user_access = getAll(2);//Se obtienen todos los registros y se llena el array mediante los usuarios encontrados en la base de datos.
        ...
        <div class="section-container tabs" data-section>
          <section class="section">
            <div class="content" data-slug="panel1">
              ...
              <td><a href="./addB.php" class="button radius tiny success">Agregar nuevo registro</a></td>
              <?php if($total_users){ ?>
              <table>
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="./updateB.php?id=<?php echo($user['id']); ?>" class="button radius tiny warning"">Modificar</a></td>
