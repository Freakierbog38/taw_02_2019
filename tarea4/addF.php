...
// Revise que esté activo el metodo post
if(isset($_POST) && !empty($_POST)){
  $r = add($_POST['id'],$_POST['nombre'],$_POST['posicion'],$_POST['carrera'],$_POST['email'],1);//Llamada al metodo que llevará la información a la base de datos
