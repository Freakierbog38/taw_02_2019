...
class Datos extends Conexion{
	...
	public function registroProductoModel($datosModel, $tabla){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla (nombre, precio, cantidad) VALUES (:nombre,:precio,:cantidad)");	
	...
	public function actualizarCantidadProductoModel($datosModel, $tabla){
	...
	#BORRAR USUARIO
	#------------------------------------
	public function borrarProdudctoModel($datosModel, $tabla){
